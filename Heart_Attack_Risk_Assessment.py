...
Blood Pressure = st.number_input('Blood Pressure (mmHg) (BLOOD_PRESSURE (mmHg))', min_value=0.0, max_value=150.0,value = 10.0, step=0.1)
...
Smoking Status = st.number_input('Smoking Status (SMOKING_STATUS)', min_value=0.0, max_value=10.0, value = 10.0, step=1.0)
Chest Pain Type = st.number_input('Chest Pain Type (CHEST_PAIN_TYPE)', min_value=0.0, max_value=10.0, value=5.0, step=1.0)
